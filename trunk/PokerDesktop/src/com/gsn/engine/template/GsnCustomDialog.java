...
public class GsnCustomDialog extends Group {
	...
	public GsnCustomDialog(String title, BitmapFont font, Image background, ImageButton... buttons) {
		...
		contentLabel = new GsnLabel(title, new GsnLabel.LabelStyle(font, new Color(1, 1, 1, 1)));
